...
<body>
    ...
    <section class="bg-secondary position-relative pt-lg-3 pt-xl-4 pt-xxl-5">
        ...
        <h1 class="display-3 text-center mx-auto pt-5 my-2 my-sm-4" style="max-width: 680px;">Welcome to this forum</h1>
        ...
        <div class="row justify-content-center pt-3 pt-sm-4 pt-md-5 mt-sm-1">
            ...
            <img class="d-block mx-auto" src="assets/ico/photo2.jpg" width="322" alt="App screen"></div>
            </div>
            <div class="col-sm-6 col-lg-4 order-lg-1 overflow-hidden mt-lg-4 pt-xl-3">
            <!-- Left app sceen--><img class="d-none d-lg-block rounded-4 ms-auto" src="assets/ico/photo1.jpg" width="297" alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
            ...
            <!-- Right app screen--><img class="d-none d-lg-block rounded-4" src="assets/ico/photo3.jpg" width="297" alt="App screen" style="box-shadow: 0 .9375rem 3rem -.5rem rgba(18,34,50, .05);">
    ...
    <section class="container pt-5 mt-lg-3 mt-xl-4 mt-xxl-5">
        ...
        <div class="col-lg-5 mb-5 mb-lg-0">
            <div class="h1 text-center text-lg-start pb-md-2 pb-xl-0 mb-4 mb-xl-5">Improve your skills and gain knowledge in one application. Become the best version of yourself</div>
    ...
    <section class="container pt-5 mt-lg-
